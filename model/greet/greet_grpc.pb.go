...
type GreetClient interface {
	SayHello(ctx context.Context, in *Hello, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *greetClient) SayHello(ctx context.Context, in *Hello, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
type GreetServer interface {
	SayHello(context.Context, *Hello) (*Result, error)
...
func (UnimplementedGreetServer) SayHello(context.Context, *Hello) (*Result, error) {
...
func _Greet_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServer).SayHello(ctx, req.(*Hello))
	}
